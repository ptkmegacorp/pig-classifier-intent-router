...
const catalog = [
  { name: "take-screenshot", description: "", filePath: "/tmp/SKILL.md", baseDir: "/tmp", commandName: null, family: "screen", keywords: [], examples: [], negativeExamples: [], intents: {}, compilerIntents: [], compilerLowering: [
  ...
  { name: "take-photo", description: "", filePath: "/tmp/SKILL.md", baseDir: "/tmp", commandName: null, family: "image", keywords: [], examples: [], negativeExamples: [], intents: {}, compilerIntents: [], compilerLowering: [
  ...
  { name: "weather", description: "", filePath: "/tmp/SKILL.md", baseDir: "/tmp", commandName: null, family: "weather", keywords: [], examples: [], negativeExamples: [], intents: {}, compilerIntents: [], compilerLowering: [
